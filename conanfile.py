...
class mybigballsConan(ConanFile):
    name = "mybigballs" # The package name should be the library's name
    version = "0.1.0"
    ...
    def package_info(self):
        ...
        self.cpp_info.libs = ["mybigballslib"] #Only if you have single lib if you component then
